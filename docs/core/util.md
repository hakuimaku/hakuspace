...
- **What it does:** It forcefully wipes out everything in your `~/.cache` folder, clears out unneeded package files using `yay -Sc`, and vacuums up `systemd` journal logs that are older than two weeks.
